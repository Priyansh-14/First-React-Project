...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[je], delete n[At], delete n[go], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Rd({ onFormSubmit: e }) {
  const [n, t] = Jn.useState(""),
    r = (o) => {
      o.preventDefault(), e(n);
    },
    l = (o) => {
      t(o.target.value);
    };
  return G.jsxs("form", {
    ...
    children: [
      ...
      G.jsx("button", { type: "submit", children: "Submit" }),
    ],
  });
}
function Od() {
  const e = Math.floor(Math.random() * 151) + 1,
    n = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${e}.png`;
  return G.jsxs("div", {
    className: "pokemon",
    children: [
      G.jsxs("h1", { children: [" You are Pokemon #", e] }),
      G.jsx("img", {
        src: n,
        alt: "Pokemon Image",
        width: "200",
...
function Md() {
  ...
  return G.jsxs(G.Fragment, {
    children: [
      G.jsx("h1", { children: "Trying Vite" }),
      G.jsxs("button", {
        onClick: () => n((o) => o + 1),
        children: ["count is ", e],
      }),
      G.jsxs("h1", { children: ["Hello ", t, " "] }),
      G.jsx("p", { children: "Let's See Which Pokemon You Are:" }),
      G.jsx(Rd, { onFormSubmit: l }),
      t ? G.jsx(Od, {}) : G.jsx("p", { children: "Enter Your Name" }),
    ],
  });
}
Ql.createRoot(document.getElementById("root")).render(
  G.jsx(gc.StrictMode, { children: G.jsx(Md, {}) })
);
